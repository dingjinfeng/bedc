...
/**
 * The step that packs {@link QrRefund} data and sends them to the server.
 *
 * @author Janson
 * @date 2021/9/13 15:30
 */
class PackQrRefundStep extends BaseStep {
    ...
    public void intercept(Callback callback) {
        ...
        try {
            ...
            iso8583.setField(61, pubBean.getOrigBizOrderNo());
