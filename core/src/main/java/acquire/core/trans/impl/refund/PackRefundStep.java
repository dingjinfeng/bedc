...
/**
 * The {@link BaseStep} that packs {@link Refund} 8583 and sends them to the server.
 *
 * @author Janson
 * @date 2019/7/25 9:35
 */
class PackRefundStep extends BaseStep {
    ...
    public void intercept(Callback callback)  {
        ...
        try {
            ...
            if (pubBean.getEntryMode() != EntryMode.MAG &&  !TextUtils.isEmpty(pubBean.getCardNo())) {
...
//            iso8583.setField(57, new PinpadHelper().getKsn());
            iso8583.setField( 60, "25"+pubBean.getBatchNo());
            iso8583.setField(61,pubBean.getBatchNo()+pubBean.getTraceNo()+pubBean.getDate());
//            iso8583.setField(62, pubBean.getBatchNo());
//            iso8583.setField(63,"000000");
